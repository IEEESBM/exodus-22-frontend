...
//     return (
//         <><div className="sign">
//             <div className="title11">Forgot Password ?
//             <div className="title2">No worries,we'll send you reset instructions.</div></div>
//         </div><div>
//                 <main className="box1">
//                     <form>
//                         <div className="inputBox">
...
//                         <Link className="login-link" to="/login" style={{ float: "center" }}><span className="login-span">Back to Login now!</span></Link>
